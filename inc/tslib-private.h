...
struct tslib_module_info *input_mod_init(struct tsdev *dev, const char *params);
struct tslib_module_info *pthres_mod_init(struct tsdev *dev, const char *params);
struct tslib_module_info *variance_mod_init(struct tsdev *dev, const char *params);
struct tslib_module_info *dejitter_mod_init(struct tsdev *dev, const char *params);
